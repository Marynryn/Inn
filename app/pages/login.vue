...
@media (max-width: 760px) {
  ...
  /* Координаты сняты с самой login-mobile.webp: лист без нижнего рулона занимает
     по вертикали 26.0…74.3% кадра (центр 50.15%), средняя ось — 35.36%. Форма
     центрируется внутри .sheet, поэтому центр блока = центр её рамки:
     left = 35.36 − 37/2, top = 50.15 − 43/2. */
  .sheet {
    left: 16.9%;
    width: 37%;
    top: 28.7%;
