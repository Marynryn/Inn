...
/*
 * Высота — от ширины, а не в процентах: проценты здесь молча не работают.
 * Картинка лежит клеткой сетки, а высоту клетки браузер считает неопределённой,
 * и height: 100% превращается в height: auto — фотография берёт свою природную
 * пропорцию и вылезает из кружка. На квадратных аватарках это незаметно, а
 * портрет 1536×2048 растягивал круг в эллипс.
 */
.ua-pic {
  width: 100%;
  aspect-ratio: 1;
